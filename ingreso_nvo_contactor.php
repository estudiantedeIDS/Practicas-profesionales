...
<head>
    ...
    <title>Ingreso nuevo Contactor"</title>
...
<body>    
       ...
       <div>
        <form action="php/captura_nvo_contactor.php" method="POST">
        <center><br><br><br><br><br> 
              <h2>Ingreso nuevo Contactor:</h2> <br><br>
              ...
              <label for="area">Ingrese el Area del Contactor</label>
