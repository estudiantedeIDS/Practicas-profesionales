...
<head>
    ...
    <title>Ingreso nuevo Relevador</title>    
...
<body>    
       ...
       <div>
        <form action="php/captura_nvo_relevador.php" method="POST">
        <center><br><br><br><br><br> 
              <h2>Ingreso nuevo Relevador:</h2> <br><br>
              ...
              <label for="area">Ingrese el Area del Relevador</label>
